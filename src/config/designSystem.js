// ============================================
// DESIGN SYSTEM V6 - FitFlow Pro Platform
// Dynamic Tenant Theming - Default Blue
// ============================================
...
export const colors = {
  ...
  bg: {
    ...
    glass: 'bg-theme-bg-secondary/30 backdrop-blur-xl',
    glassPremium: 'bg-gradient-to-br from-theme-bg-secondary/40 to-theme-bg-secondary/20 backdrop-blur-xl',
    surface: 'bg-theme-bg-primary/40',
    header: 'bg-theme-bg-secondary/70 backdrop-blur-xl',
    gradient: {
      primary: 'bg-gradient-to-r from-blue-500 via-blue-600 to-sky-500',
      secondary: 'bg-gradient-to-r from-blue-400 via-blue-500 to-sky-400',
      success: 'bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-400',
      ...
      purple: 'bg-gradient-to-r from-blue-500 via-sky-400 to-cyan-400',
      premium: 'bg-gradient-to-r from-blue-400 via-sky-400 to-cyan-300',
    },
  },
...
export const shadows = {
  ...
  nebula: 'shadow-[0_0_30px_rgba(59,130,246,0.12),0_8px_32px_rgba(0,0,0,0.25)]',
};
...
export const components = {
  ...
  button: {
    primary: `bg-gradient-to-r from-blue-500 via-blue-600 to-sky-500 text-white preserve-white font-semibold py-2.5 px-6 rounded-xl ${transitions.smooth} hover:from-blue-600 hover:via-blue-700 hover:to-sky-600 hover:-translate-y-0.5 active:translate-y-0 ${shadows.glow} ${shadows.glowHover} focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:ring-offset-2 focus:ring-offset-transparent disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0`,
    secondary: `bg-theme-bg-secondary/60 backdrop-blur-sm text-theme-text-primary font-semibold py-2.5 px-6 rounded-xl border ${colors.border.default} ${transitions.smooth} hover:bg-theme-bg-tertiary/70 hover:border-blue-500/30 hover:-translate-y-0.5 active:translate-y-0 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:ring-offset-2 focus:ring-offset-transparent`,
    ghost: `text-theme-text-secondary font-semibold py-2.5 px-5 rounded-xl ${transitions.smooth} hover:bg-theme-bg-tertiary/50 hover:text-theme-text-primary focus:outline-none focus:ring-2 focus:ring-blue-500/20`,
    ...
    success: `bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-400 text-white preserve-white font-semibold py-2.5 px-6 rounded-xl ${transitions.smooth} hover:from-emerald-600 hover:via-teal-600 hover:to-emerald-500 hover:-translate-y-0.5 active:translate-y-0 ${shadows.glowSuccess} focus:outline-none focus:ring-2 focus:ring-emerald-500/40`,
    icon: `p-2.5 rounded-xl ${colors.bg.glass} border border-theme/50 ${transitions.smooth} hover:bg-theme-bg-tertiary/60 hover:border-blue-500/30 focus:outline-none focus:ring-2 focus:ring-blue-500/20`,
    outline: `border-2 border-blue-500/50 text-blue-400 font-semibold py-2.5 px-6 rounded-xl ${transitions.smooth} hover:bg-blue-500/10 hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30`,
  },
  
  // Inputs - Blue focus states
  input: {
  ...
  badge: {
    ...
    premium: `inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-gradient-to-r from-blue-500/20 to-sky-500/20 text-sky-400 border border-sky-500/30 backdrop-blur-sm`,
  },
  ...
  sidebar: {
    ...
    itemActive: `flex items-center gap-3 px-4 py-3 rounded-xl bg-blue-500/10 border ${colors.border.accent} text-blue-400 shadow-sm shadow-blue-500/10`,
  },
  ...
  proCard: {
    ...
    premium: `bg-gradient-to-br from-blue-500/5 via-theme-bg-secondary/60 to-sky-500/5 backdrop-blur-xl border border-blue-500/20 rounded-2xl p-5 ${shadows.soft}`,
  },
...
export const badges = {
  ...
  info: 'inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-violet-500/10 text-violet-400 border border-violet-500/30',
  ...
  primary: 'inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-violet-500/10 text-violet-400 border border-violet-500/30',
  premium: 'inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-violet-500/15 to-fuchsia-500/15 text-fuchsia-300 border border-fuchsia-500/30',
};
