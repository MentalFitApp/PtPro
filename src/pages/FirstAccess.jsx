            ...
            >
                ...
                <form onSubmit={handleChangePassword} className="space-y-6">
                    ...
                    <AnimatePresence>
                        ...
                        {success && <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="text-emerald-400 text-sm text-center flex items-center justify-center gap-2"><CheckCircle2 size={16}/>{success}</motion.p>}
                    </AnimatePresence>

                    <div>
                        <button type="submit" className="w-full px-4 py-2.5 font-bold text-white bg-cyan-600 rounded-lg hover:bg-cyan-700 disabled:opacity-50 transition-colors" disabled={isSubmitting || !!success}>
