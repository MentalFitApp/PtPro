 ...
 */
export default function WorkoutStreak({ compact = false }) {
  ...
  if (compact) {
    return (
      <div className="bg-gradient-to-br from-orange-500/20 to-rose-500/20 border border-orange-500/30 rounded-xl p-4">
