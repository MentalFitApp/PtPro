 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zm="type.googleapis.com/google.protobuf.Int64Value",Km="type.googleapis.com/google.protobuf.UInt64Value";function gl(n,t){const e={};for(const r in n)n.hasOwnProperty(r)&&(e[r]=t(n[r]));return e}function ui(n){if(n==null)return null;if(n instanceof Number&&(n=n.valueOf()),typeof n=="number"&&isFinite(n)||n===!0||n===!1||Object.prototype.toString.call(n)==="[object String]")return n;if(n instanceof Date)return n.toISOString();if(Array.isArray(n))return n.map(t=>ui(t));if(typeof n=="function"||typeof n=="object")return gl(n,t=>ui(t));throw new Error("Data cannot be encoded in JSON: "+n)}function Vr(n){if(n==null)return n;if(n["@type"])switch(n["@type"]){case zm:case Km:{const t=Number(n.value);if(isNaN(t))throw new Error("Data cannot be decoded from JSON: "+n);return t}default:throw new Error("Data cannot be decoded from JSON: "+n)}return Array.isArray(n)?n.map(t=>Vr(t)):typeof n=="function"||typeof n=="object"?gl(n,t=>Vr(t)):n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const du={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class Le extends Jt{constructor(t,e,r){super(`${so}/${t}`,e||""),this.details=r}}function Hm(n){if(n>=200&&n<300)return"ok";switch(n){case 0:return"internal";case 400:return"invalid-argument";case 401:return"unauthenticated";case 403:return"permission-denied";case 404:return"not-found";case 409:return"aborted";case 429:return"resource-exhausted";case 499:return"cancelled";case 500:return"internal";case 501:return"unimplemented";case 503:return"unavailable";case 504:return"deadline-exceeded"}return"unknown"}function Gm(n,t){let e=Hm(n),r=e,s;try{const o=t&&t.error;if(o){const a=o.status;if(typeof a=="string"){if(!du[a])return new Le("internal","internal");e=du[a],r=a}const c=o.message;typeof c=="string"&&(r=c),s=o.details,s!==void 0&&(s=Vr(s))}}catch{}return e==="ok"?null:new Le(e,r,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wm{constructor(t,e,r){this.auth=null,this.messaging=null,this.appCheck=null,this.auth=t.getImmediate({optional:!0}),this.messaging=e.getImmediate({optional:!0}),this.auth||t.get().then(s=>this.auth=s,()=>{}),this.messaging||e.get().then(s=>this.messaging=s,()=>{}),this.appCheck||r.get().then(s=>this.appCheck=s,()=>{})}async getAuthToken(){if(this.auth)try{const t=await this.auth.getToken();return t==null?void 0:t.accessToken}catch{return}}async getMessagingToken(){if(!(!this.messaging||!("Notification"in self)||Notification.permission!=="granted"))try{return await this.messaging.getToken()}catch{return}}async getAppCheckToken(t){if(this.appCheck){const e=t?await this.appCheck.getLimitedUseToken():await this.appCheck.getToken();return e.error?null:e.token}return null}async getContext(t){const e=await this.getAuthToken(),r=await this.getMessagingToken(),s=await this.getAppCheckToken(t);return{authToken:e,messagingToken:r,appCheckToken:s}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ci="us-central1";function Qm(n){let t=null;return{promise:new Promise((e,r)=>{t=setTimeout(()=>{r(new Le("deadline-exceeded","deadline-exceeded"))},n)}),cancel:()=>{t&&clearTimeout(t)}}}class Xm{constructor(t,e,r,s,o=ci,a){this.app=t,this.fetchImpl=a,this.emulatorOrigin=null,this.contextProvider=new Wm(e,r,s),this.cancelAllRequests=new Promise(c=>{this.deleteService=()=>Promise.resolve(c())});try{const c=new URL(o);this.customDomain=c.origin+(c.pathname==="/"?"":c.pathname),this.region=ci}catch{this.customDomain=null,this.region=o}}_delete(){return this.deleteService()}_url(t){const e=this.app.options.projectId;return this.emulatorOrigin!==null?`${this.emulatorOrigin}/${e}/${this.region}/${t}`:this.customDomain!==null?`${this.customDomain}/${t}`:`https://${this.region}-${e}.cloudfunctions.net/${t}`}}function Ym(n,t,e){n.emulatorOrigin=`http://${t}:${e}`}function Jm(n,t,e){return r=>t_(n,t,r,{})}async function Zm(n,t,e,r){e["Content-Type"]="application/json";let s;try{s=await r(n,{method:"POST",body:JSON.stringify(t),headers:e})}catch{return{status:0,json:null}}let o=null;try{o=await s.json()}catch{}return{status:s.status,json:o}}function t_(n,t,e,r){const s=n._url(t);return e_(n,s,e,r)}async function e_(n,t,e,r){e=ui(e);const s={data:e},o={},a=await n.contextProvider.getContext(r.limitedUseAppCheckTokens);a.authToken&&(o.Authorization="Bearer "+a.authToken),a.messagingToken&&(o["Firebase-Instance-ID-Token"]=a.messagingToken),a.appCheckToken!==null&&(o["X-Firebase-AppCheck"]=a.appCheckToken);const c=r.timeout||7e4,h=Qm(c),d=await Promise.race([Zm(t,s,o,n.fetchImpl),h.promise,n.cancelAllRequests]);if(h.cancel(),!d)throw new Le("cancelled","Firebase Functions instance was deleted.");const p=Gm(d.status,d.json);if(p)throw p;if(!d.json)throw new Le("internal","Response is not valid JSON object.");let E=d.json.data;if(typeof E>"u"&&(E=d.json.result),typeof E>"u")throw new Le("internal","Response is missing data field.");return{data:Vr(E)}}const fu="@firebase/functions",pu="0.11.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const n_="auth-internal",r_="app-check-internal",s_="messaging-internal";function i_(n,t){const e=(r,{instanceIdentifier:s})=>{const o=r.getProvider("app").getImmediate(),a=r.getProvider(n_),c=r.getProvider(s_),h=r.getProvider(r_);return new Xm(o,a,c,h,s,n)};Bt(new xt(so,e,"PUBLIC").setMultipleInstances(!0)),Dt(fu,pu,t),Dt(fu,pu,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fE(n=xr(),t=ci){const r=He(ot(n),so).getImmediate({identifier:t}),s=hi("functions");return s&&o_(r,...s),r}function o_(n,t,e){Ym(ot(n),t,e)}function pE(n,t,e){return Jm(ot(n),t)}i_(fetch.bind(self));const ml="@firebase/installations",io="0.6.9";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _l=1e4,yl=`w:${io}`,El="FIS_v2",a_="https://firebaseinstallations.googleapis.com/v1",u_=60*60*1e3,c_="installations",l_="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vl({projectId:n}){return`${a_}/projects/${n}/installations`}function wl(n){return{token:n.token,requestStatus:2,expiresIn:f_(n.expiresIn),creationTime:Date.now()}}async function Il(n,t){const r=(await t.json()).error;return Ae.create("request-failed",{requestName:n,serverCode:r.code,serverMessage:r.message,serverStatus:r.status})}function Al({apiKey:n}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":n})}function d_(n,{refreshToken:t}){const e=Al(n);return e.append("Authorization",p_(t)),e}async function Rl(n){const t=await n();return t.status>=500&&t.status<600?n():t}function f_(n){return Number(n.replace("s","000"))}function p_(n){return`${El} ${n}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function g_({appConfig:n,heartbeatServiceProvider:t},{fid:e}){const r=vl(n),s=Al(n),o=t.getImmediate({optional:!0});if(o){const d=await o.getHeartbeatsHeader();d&&s.append("x-firebase-client",d)}const a={fid:e,authVersion:El,appId:n.appId,sdkVersion:yl},c={method:"POST",headers:s,body:JSON.stringify(a)},h=await Rl(()=>fetch(r,c));if(h.ok){const d=await h.json();return{fid:d.fid||e,registrationStatus:2,refreshToken:d.refreshToken,authToken:wl(d.authToken)}}else throw await Il("Create Installation",h)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bl(n){return new Promise(t=>{setTimeout(t,n)})}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const __=/^[cdef][\w-]{21}$/,li="";function y_(){try{const n=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(n),n[0]=112+n[0]%16;const e=E_(n);return __.test(e)?e:li}catch{return li}}function E_(n){return m_(n).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sl=new Map;function Pl(n,t){const e=es(n);Cl(e,t),T_(e,t)}function Cl(n,t){const e=Sl.get(n);if(e)for(const r of e)r(t)}function T_(n,t){const e=v_();e&&e.postMessage({key:n,fid:t}),w_()}let _e=null;function v_(){return!_e&&"BroadcastChannel"in self&&(_e=new BroadcastChannel("[Firebase] FID Change"),_e.onmessage=n=>{Cl(n.data.key,n.data.fid)}),_e}function w_(){Sl.size===0&&_e&&(_e.close(),_e=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I_="firebase-installations-database",A_=1,Re="firebase-installations-store";let Ms=null;function oo(){return Ms||(Ms=Dr(I_,A_,{upgrade:(n,t)=>{switch(t){case 0:n.createObjectStore(Re)}}})),Ms}async function kr(n,t){const e=es(n),s=(await oo()).transaction(Re,"readwrite"),o=s.objectStore(Re),a=await o.get(e);return await o.put(t,e),await s.done,(!a||a.fid!==t.fid)&&Pl(n,t.fid),t}async function Vl(n){const t=es(n),r=(await oo()).transaction(Re,"readwrite");await r.objectStore(Re).delete(t),await r.done}async function ns(n,t){const e=es(n),s=(await oo()).transaction(Re,"readwrite"),o=s.objectStore(Re),a=await o.get(e),c=t(a);return c===void 0?await o.delete(e):await o.put(c,e),await s.done,c&&(!a||a.fid!==c.fid)&&Pl(n,c.fid),c}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ao(n){let t;const e=await ns(n.appConfig,r=>{const s=R_(r),o=b_(n,s);return t=o.registrationPromise,o.installationEntry});return e.fid===li?{installationEntry:await t}:{installationEntry:e,registrationPromise:t}}function R_(n){const t=n||{fid:y_(),registrationStatus:0};return kl(t)}function b_(n,t){if(t.registrationStatus===0){if(!navigator.onLine){const s=Promise.reject(Ae.create("app-offline"));return{installationEntry:t,registrationPromise:s}}const e={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},r=S_(n,e);return{installationEntry:e,registrationPromise:r}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:P_(n)}:{installationEntry:t}}async function S_(n,t){try{const e=await g_(n,t);return kr(n.appConfig,e)}catch(e){throw Tl(e)&&e.customData.serverCode===409?await Vl(n.appConfig):await kr(n.appConfig,{fid:t.fid,registrationStatus:0}),e}}async function P_(n){let t=await gu(n.appConfig);for(;t.registrationStatus===1;)await bl(100),t=await gu(n.appConfig);if(t.registrationStatus===0){const{installationEntry:e,registrationPromise:r}=await ao(n);return r||e}return t}function gu(n){return ns(n,t=>{if(!t)throw Ae.create("installation-not-found");return kl(t)})}function kl(n){return C_(n)?{fid:n.fid,registrationStatus:0}:n}function C_(n){return n.registrationStatus===1&&n.registrationTime+_l<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function V_({appConfig:n,heartbeatServiceProvider:t},e){const r=k_(n,e),s=d_(n,e),o=t.getImmediate({optional:!0});if(o){const d=await o.getHeartbeatsHeader();d&&s.append("x-firebase-client",d)}const a={installation:{sdkVersion:yl,appId:n.appId}},c={method:"POST",headers:s,body:JSON.stringify(a)},h=await Rl(()=>fetch(r,c));if(h.ok){const d=await h.json();return wl(d)}else throw await Il("Generate Auth Token",h)}function k_(n,{fid:t}){return`${vl(n)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uo(n,t=!1){let e;const r=await ns(n.appConfig,o=>{if(!Dl(o))throw Ae.create("not-registered");const a=o.authToken;if(!t&&O_(a))return o;if(a.requestStatus===1)return e=D_(n,t),o;{if(!navigator.onLine)throw Ae.create("app-offline");const c=M_(o);return e=N_(n,c),c}});return e?await e:r.authToken}async function D_(n,t){let e=await mu(n.appConfig);for(;e.authToken.requestStatus===1;)await bl(100),e=await mu(n.appConfig);const r=e.authToken;return r.requestStatus===0?uo(n,t):r}function mu(n){return ns(n,t=>{if(!Dl(t))throw Ae.create("not-registered");const e=t.authToken;return L_(e)?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t})}async function N_(n,t){try{const e=await V_(n,t),r=Object.assign(Object.assign({},t),{authToken:e});return await kr(n.appConfig,r),e}catch(e){if(Tl(e)&&(e.customData.serverCode===401||e.customData.serverCode===404))await Vl(n.appConfig);else{const r=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await kr(n.appConfig,r)}throw e}}function Dl(n){return n!==void 0&&n.registrationStatus===2}function O_(n){return n.requestStatus===2&&!x_(n)}function x_(n){const t=Date.now();return t<n.creationTime||n.creationTime+n.expiresIn<t+u_}function M_(n){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},n),{authToken:t})}function L_(n){return n.requestStatus===1&&n.requestTime+_l<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function F_(n){const t=n,{installationEntry:e,registrationPromise:r}=await ao(t);return r?r.catch(console.error):uo(t).catch(console.error),e.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function U_(n,t=!1){const e=n;return await B_(e),(await uo(e,t)).token}async function B_(n){const{registrationPromise:t}=await ao(n);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function q_(n){if(!n||!n.options)throw Ls("App Configuration");if(!n.name)throw Ls("App Name");const t=["projectId","apiKey","appId"];for(const e of t)if(!n.options[e])throw Ls(e);return{appName:n.name,projectId:n.options.projectId,apiKey:n.options.apiKey,appId:n.options.appId}}function Ls(n){return Ae.create("missing-app-config-values",{valueName:n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nl="installations",$_="installations-internal",j_=n=>{const t=n.getProvider("app").getImmediate(),e=q_(t),r=He(t,"heartbeat");return{app:t,appConfig:e,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},z_=n=>{const t=n.getProvider("app").getImmediate(),e=He(t,Nl).getImmediate();return{getId:()=>F_(e),getToken:s=>U_(e,s)}};function K_(){Bt(new xt(Nl,j_,"PUBLIC")),Bt(new xt($_,z_,"PRIVATE"))}K_();Dt(ml,io);Dt(ml,io,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const H_="/firebase-messaging-sw.js",G_="/firebase-cloud-messaging-push-scope",Ol="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",W_="https://fcmregistrations.googleapis.com/v1",xl="google.c.a.c_id",Q_="google.c.a.c_l",X_="google.c.a.ts",Y_="google.c.a.e";var _u;(function(n){n[n.DATA_MESSAGE=1]="DATA_MESSAGE",n[n.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(_u||(_u={}));/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ht(n){const t=new Uint8Array(n);return btoa(String.fromCharCode(...t)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function J_(n){const t="=".repeat((4-n.length%4)%4),e=(n+t).replace(/\-/g,"+").replace(/_/g,"/"),r=atob(e),s=new Uint8Array(r.length);for(let o=0;o<r.length;++o)s[o]=r.charCodeAt(o);return s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ny="firebase-messaging-database",ry=1,xn="firebase-messaging-store";let Us=null;function Ml(){return Us||(Us=Dr(ny,ry,{upgrade:(n,t)=>{switch(t){case 0:n.createObjectStore(xn)}}})),Us}async function sy(n){const t=Ll(n),r=await(await Ml()).transaction(xn).objectStore(xn).get(t);if(r)return r;{const s=await ty(n.appConfig.senderId);if(s)return await co(n,s),s}}async function co(n,t){const e=Ll(n),s=(await Ml()).transaction(xn,"readwrite");return await s.objectStore(xn).put(t,e),await s.done,t}function Ll({appConfig:n}){return n.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iy={"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"only-available-in-window":"This method is available in a Window context.","only-available-in-sw":"This method is available in a service worker context.","permission-default":"The notification permission was not granted and dismissed instead.","permission-blocked":"The notification permission was not granted and blocked instead.","unsupported-browser":"This browser doesn't support the API's required to use the Firebase SDK.","indexed-db-unsupported":"This browser doesn't support indexedDb.open() (ex. Safari iFrame, Firefox Private Browsing, etc)","failed-service-worker-registration":"We are unable to register the default service worker. {$browserErrorMessage}","token-subscribe-failed":"A problem occurred while subscribing the user to FCM: {$errorInfo}","token-subscribe-no-token":"FCM returned no token when subscribing the user to push.","token-unsubscribe-failed":"A problem occurred while unsubscribing the user from FCM: {$errorInfo}","token-update-failed":"A problem occurred while updating the user from FCM: {$errorInfo}","token-update-no-token":"FCM returned no token when updating the user to push.","use-sw-after-get-token":"The useServiceWorker() method may only be called once and must be called before calling getToken() to ensure your service worker is used.","invalid-sw-registration":"The input to useServiceWorker() must be a ServiceWorkerRegistration.","invalid-bg-handler":"The input to setBackgroundMessageHandler() must be a function.","invalid-vapid-key":"The public VAPID key must be a string.","use-vapid-key-after-get-token":"The usePublicVapidKey() method may only be called once and must be called before calling getToken() to ensure your VAPID key is used."},wt=new Or("messaging","Messaging",iy);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oy(n,t){const e=await ho(n),r=Fl(t),s={method:"POST",headers:e,body:JSON.stringify(r)};let o;try{o=await(await fetch(lo(n.appConfig),s)).json()}catch(a){throw wt.create("token-subscribe-failed",{errorInfo:a==null?void 0:a.toString()})}if(o.error){const a=o.error.message;throw wt.create("token-subscribe-failed",{errorInfo:a})}if(!o.token)throw wt.create("token-subscribe-no-token");return o.token}async function ay(n,t){const e=await ho(n),r=Fl(t.subscriptionOptions),s={method:"PATCH",headers:e,body:JSON.stringify(r)};let o;try{o=await(await fetch(`${lo(n.appConfig)}/${t.token}`,s)).json()}catch(a){throw wt.create("token-update-failed",{errorInfo:a==null?void 0:a.toString()})}if(o.error){const a=o.error.message;throw wt.create("token-update-failed",{errorInfo:a})}if(!o.token)throw wt.create("token-update-no-token");return o.token}async function uy(n,t){const r={method:"DELETE",headers:await ho(n)};try{const o=await(await fetch(`${lo(n.appConfig)}/${t}`,r)).json();if(o.error){const a=o.error.message;throw wt.create("token-unsubscribe-failed",{errorInfo:a})}}catch(s){throw wt.create("token-unsubscribe-failed",{errorInfo:s==null?void 0:s.toString()})}}function lo({projectId:n}){return`${W_}/projects/${n}/registrations`}async function ho({appConfig:n,installations:t}){const e=await t.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":n.apiKey,"x-goog-firebase-installations-auth":`FIS ${e}`})}function Fl({p256dh:n,auth:t,endpoint:e,vapidKey:r}){const s={web:{endpoint:e,auth:t,p256dh:n}};return r!==Ol&&(s.web.applicationPubKey=r),s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cy=7*24*60*60*1e3;async function ly(n){const t=await dy(n.swRegistration,n.vapidKey),e={vapidKey:n.vapidKey,swScope:n.swRegistration.scope,endpoint:t.endpoint,auth:Ht(t.getKey("auth")),p256dh:Ht(t.getKey("p256dh"))},r=await sy(n.firebaseDependencies);if(r){if(fy(r.subscriptionOptions,e))return Date.now()>=r.createTime+cy?hy(n,{token:r.token,createTime:Date.now(),subscriptionOptions:e}):r.token;try{await uy(n.firebaseDependencies,r.token)}catch(s){console.warn(s)}return Eu(n.firebaseDependencies,e)}else return Eu(n.firebaseDependencies,e)}async function hy(n,t){try{const e=await ay(n.firebaseDependencies,t),r=Object.assign(Object.assign({},t),{token:e,createTime:Date.now()});return await co(n.firebaseDependencies,r),e}catch(e){throw e}}async function Eu(n,t){const r={token:await oy(n,t),createTime:Date.now(),subscriptionOptions:t};return await co(n,r),r.token}async function dy(n,t){const e=await n.pushManager.getSubscription();return e||n.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:J_(t)})}function fy(n,t){const e=t.vapidKey===n.vapidKey,r=t.endpoint===n.endpoint,s=t.auth===n.auth,o=t.p256dh===n.p256dh;return e&&r&&s&&o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tu(n){const t={from:n.from,collapseKey:n.collapse_key,messageId:n.fcmMessageId};return py(t,n),gy(t,n),my(t,n),t}function py(n,t){if(!t.notification)return;n.notification={};const e=t.notification.title;e&&(n.notification.title=e);const r=t.notification.body;r&&(n.notification.body=r);const s=t.notification.image;s&&(n.notification.image=s);const o=t.notification.icon;o&&(n.notification.icon=o)}function gy(n,t){t.data&&(n.data=t.data)}function my(n,t){var e,r,s,o,a;if(!t.fcmOptions&&!(!((e=t.notification)===null||e===void 0)&&e.click_action))return;n.fcmOptions={};const c=(s=(r=t.fcmOptions)===null||r===void 0?void 0:r.link)!==null&&s!==void 0?s:(o=t.notification)===null||o===void 0?void 0:o.click_action;c&&(n.fcmOptions.link=c);const h=(a=t.fcmOptions)===null||a===void 0?void 0:a.analytics_label;h&&(n.fcmOptions.analyticsLabel=h)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _y(n){return typeof n=="object"&&!!n&&xl in n}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yy(n){if(!n||!n.options)throw Bs("App Configuration Object");if(!n.name)throw Bs("App Name");const t=["projectId","apiKey","appId","messagingSenderId"],{options:e}=n;for(const r of t)if(!e[r])throw Bs(r);return{appName:n.name,projectId:e.projectId,apiKey:e.apiKey,appId:e.appId,senderId:e.messagingSenderId}}function Bs(n){return wt.create("missing-app-config-values",{valueName:n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ey{constructor(t,e,r){this.deliveryMetricsExportedToBigQueryEnabled=!1,this.onBackgroundMessageHandler=null,this.onMessageHandler=null,this.logEvents=[],this.isLogServiceStarted=!1;const s=yy(t);this.firebaseDependencies={app:t,appConfig:s,installations:e,analyticsProvider:r}}_delete(){return Promise.resolve()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ty(n){try{n.swRegistration=await navigator.serviceWorker.register(H_,{scope:G_}),n.swRegistration.update().catch(()=>{})}catch(t){throw wt.create("failed-service-worker-registration",{browserErrorMessage:t==null?void 0:t.message})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vy(n,t){if(!t&&!n.swRegistration&&await Ty(n),!(!t&&n.swRegistration)){if(!(t instanceof ServiceWorkerRegistration))throw wt.create("invalid-sw-registration");n.swRegistration=t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wy(n,t){t?n.vapidKey=t:n.vapidKey||(n.vapidKey=Ol)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ul(n,t){if(!navigator)throw wt.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw wt.create("permission-blocked");return await wy(n,t==null?void 0:t.vapidKey),await vy(n,t==null?void 0:t.serviceWorkerRegistration),ly(n)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Iy(n,t,e){const r=Ay(t);(await n.firebaseDependencies.analyticsProvider.get()).logEvent(r,{message_id:e[xl],message_name:e[Q_],message_time:e[X_],message_device_time:Math.floor(Date.now()/1e3)})}function Ay(n){switch(n){case On.NOTIFICATION_CLICKED:return"notification_open";case On.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ry(n,t){const e=t.data;if(!e.isFirebaseMessaging)return;n.onMessageHandler&&e.messageType===On.PUSH_RECEIVED&&(typeof n.onMessageHandler=="function"?n.onMessageHandler(Tu(e)):n.onMessageHandler.next(Tu(e)));const r=e.data;_y(r)&&r[Y_]==="1"&&await Iy(n,e.messageType,r)}const vu="@firebase/messaging",wu="0.12.12";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const by=n=>{const t=new Ey(n.getProvider("app").getImmediate(),n.getProvider("installations-internal").getImmediate(),n.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",e=>Ry(t,e)),t},Sy=n=>{const t=n.getProvider("messaging").getImmediate();return{getToken:r=>Ul(t,r)}};function Py(){Bt(new xt("messaging",by,"PUBLIC")),Bt(new xt("messaging-internal",Sy,"PRIVATE")),Dt(vu,wu),Dt(vu,wu,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cy(){try{await Pu()}catch{return!1}return typeof window<"u"&&Su()&&Nh()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vy(n,t){if(!navigator)throw wt.create("only-available-in-window");return n.onMessageHandler=t,()=>{n.onMessageHandler=null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gE(n=xr()){return Cy().then(t=>{if(!t)throw wt.create("unsupported-browser")},t=>{throw wt.create("indexed-db-unsupported")}),He(ot(n),"messaging").getImmediate()}async function mE(n,t){return n=ot(n),Ul(n,t)}function _E(n,t){return n=ot(n),Vy(n,t)}Py();export{mE as $,sE as A,iE as B,xt as C,aE as D,Or as E,Jt as F,Wy as G,Yy as H,Zy as I,Qy as J,rE as K,Cu as L,uE as M,nE as N,lE as O,hE as P,tE as Q,Jy as R,Vu as S,oE as T,cE as U,fE as V,zy as W,pE as X,gE as Y,_E as Z,Bt as _,My as a,xy as b,jy as c,ot as d,di as e,$y as f,Dy as g,K as h,Ny as i,Ah as j,xr as k,He as l,Ch as m,qs as n,Ly as o,Fy as p,Uy as q,Dt as r,By as s,qy as t,Oy as u,Rd as v,Xy as w,dE as x,wg as y,eE as z};
